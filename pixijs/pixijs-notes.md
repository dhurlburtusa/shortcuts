...
- By rendering a container and its children to a texture, `Container#cacheAsTexture` can significantly improve performance for static or infrequently updated containers. See [Cache as Texture guide](https://pixijs.com/8.x/guides/components/scene-objects/container/cache-as-texture) for details.
